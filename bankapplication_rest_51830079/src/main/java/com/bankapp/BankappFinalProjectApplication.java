...
private AccountTransactionService accountTransactionService;
	...
	public void run(String... args) throws Exception {
		...
		/*Customer customer1=new Customer("gowsy", "9780808766", "g@g.com", "gowsy123") ;
		Account account1=new Account(1200.00, "SAVINGS", false);
		Customer customer2=new Customer("yuga", "978080766", "y@y.com", "yuga123") ;
		...
		AppUser appUser1=new AppUser("jam", "j@j.com", "jam123", new String[]{"ROLE_ADMIN","ROLE_MGR","ROLE_CLERK"}, true, "357429357");
		AppUser appUser2=new AppUser("bhaa", "bh@bh.com", "bhaa123", new String[]{"ROLE_CLERK"}, true, "756429357");
